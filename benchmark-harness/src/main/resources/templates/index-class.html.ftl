...
<html>
<head>
<title>Permutations for ${className}</title>
<style>
...
<a href="index.html" class="btn">&larr; Back to Permutations Directory</a>

<h1>Permutations for ${className}</h1>
<p>Select a specific configuration permutation to view its detailed historical charts and data. Generated: ${generatedAt}</p>

<div class="card">
    <ul>
        <#list permutations as perm>
            <li><a href="${perm.filename}">${perm.key}</a></li>
        </#list>
    </ul>
