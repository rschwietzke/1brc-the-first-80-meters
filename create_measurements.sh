...
java -cp $CLASSPATH org.rschwietzke.devoxxpl24.BRC15_ParseDoubleFixedsST $1 $2 $3 --batchMode ""
java -cp $CLASSPATH org.rschwietzke.devoxxpl24.BRC16_ArraysEqualsST $1 $2 $3 --batchMode ""
