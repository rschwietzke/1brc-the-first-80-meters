...
/**
 * Parallelizes the stream after reading the file.
 *
 * Difference to BRC004_BaselineFileSplitMeasurements: Inserted `.parallel()` after `Files.lines`.
 *
 * @author Gunnar Morling
 * @author René Schwietzke
 */
public class BRC010_ParallelAfterRead extends Benchmark 
{
    ...
    {
        Benchmark.run(BRC010_ParallelAfterRead.class, args);
    }
}
