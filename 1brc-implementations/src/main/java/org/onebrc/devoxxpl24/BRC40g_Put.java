 ...
 */
public class BRC40g_Put extends Benchmark
{
    /**
    ...
    static class FastHashSet
    {
        ...
        public void getPutOrUpdate(final Line line)
        {
            ...
            if ( k != FREE_KEY )
            {
                if (Arrays.equals(k.data, 0, k.data.length, line.data, line.lineStartPos, line.semicolonPos))
                {
    ...
    {
        Benchmark.run(BRC40g_Put.class, args);
    }
}
