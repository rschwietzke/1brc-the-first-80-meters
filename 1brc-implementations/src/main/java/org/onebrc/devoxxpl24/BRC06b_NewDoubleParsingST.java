 ...
 * Even more optimized version than the regular 06
 *
 * @author Rene Schwietzke
 */
public class BRC06b_NewDoubleParsingST extends Benchmark
{
	/**
    ...
    {
		Benchmark.run(BRC06b_NewDoubleParsingST.class, args);
    }
}
