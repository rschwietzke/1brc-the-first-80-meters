 ...
 */
public class BRC12_NewMapST extends Benchmark
{
	/**
    ...
    public String run(final String fileName) throws IOException
    {
    	...
    	final FastHashMap<String, Temperatures> cities = new FastHashMap<>(2023, 0.5f);
    	...
    	// the simple hashmap is not a standard collection class, so we go manual
    ...
    {
		Benchmark.run(BRC12_NewMapST.class, args);
    }
}
