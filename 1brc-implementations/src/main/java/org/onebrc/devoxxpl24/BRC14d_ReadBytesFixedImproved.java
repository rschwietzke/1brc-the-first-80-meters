 ...
 */
public class BRC14d_ReadBytesFixedImproved extends Benchmark
{
	/**
	...
	static class Line
	{
		...
		public int hashCode()
		{
			...
			{
				int h = 1;
				for (int i = this.lineStartPos; i < this.semicolonPos; i++)
				{
				    h = 31 * h + this.data[i];
				}
				this.hashCode = h;
	...
	public String run(final String fileName) throws IOException
	{
		...
		{
			final Line reader = new Line(channel);
			Line line;
	...
	{
		Benchmark.run(BRC14d_ReadBytesFixedImproved.class, args);
	}
