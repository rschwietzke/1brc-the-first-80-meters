 ...
 */
public class BRC29f_LessDataForTempResolution extends Benchmark
{
    /**
    ...
    static class Line
    {
        ...
        private void readFromChannel()
        {
            ...
            for (; i < end; i++)
            {
                ...
                {
                    // resolve temperature
                    temperature = parseDoubleAsInt(data, semicolonPos, i);
                    pos = i + 1;
    ...
    {
        Benchmark.run(BRC29f_LessDataForTempResolution.class, args);
    }
