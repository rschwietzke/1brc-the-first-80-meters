...
/**
 * We can capture the pos after the semicolon, so we don't need to
 * calculate it later on.
 * 
...
public class BRC063_OneAddLess extends Benchmark
{
    ...
    public static class Line
    {
        ...
        public boolean readLine() throws IOException
        {
            ...
            int start = ++length; // start after semicolon
            ...
            // parse temperature
            this.temperature = parseInteger(this.data, start, length); // skip newline
