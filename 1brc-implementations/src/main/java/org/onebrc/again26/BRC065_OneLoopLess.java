...
/**
 * We right now loop for the ; and for the \n. After that, we parse the temperature.
 * But we know the format of the temperature, so we can parse it directly while reading.
 * 
 * @author Rene Schwietzke
 */
public class BRC065_OneLoopLess extends Benchmark
{
    /**
     ...
     * 
     */
    public static int parseInteger(final ByteBuffer buffer)
    {
        int value;
    ...
    public static class Line
    {
        ...
        public boolean readLine() throws IOException
        {
            ...
            // parse temperature on the fly
            this.temperature = parseInteger(this.buffer); // skip newline
//            System.out.format("%s;%d%n", 
//                    new String(this.data, 0, this.semicolon), this.temperature);
    ...
    {
        Benchmark.run(BRC065_OneLoopLess.class, args);
    }
}
