...
/**
 * To avoid our char at against our strings (city), we keep the char data
 * for the moment. 
 * 
 * @author Rene Schwietzke
 */
public class BRC045_KeepChars extends Benchmark
{
    /**
    ...
    private static class City
    {
        ...
        {
            this.city = city.toCharArray();
            this.cityLength = city.length();
        ...
        {
            City other = (City)o;
            String oCity = String.valueOf(other.city);
            return this.city.equals(oCity);
        }
        ...
        public boolean equalsLine(Line line)
        {
            ...
            {
                if (this.city[i] != line.line.charAt(i))
                {
                    return false;
                }
            }
    ...
    public static class LightSet
    {
        ...
        public void update(final Line line)
        {
            ...
            if (city == null)
            {
                add(line.getCity(), index, line.temperature);
            }
        ...
        public TreeMap<String, City> toTreeMap()
        {
            ...
            for (int i = 0; i < this.data.length; i++)
            {
                ...
                if (c != null)
                {
                    map.put(String.valueOf(c.city),  c);
                }
            }
    ...
    public static class Line
    {
        ...
        public void update(final String line)
        {
            ...
            // parse temperature
            this.temperature = parseInteger(line, this.semicolon + 1, line.length()); // skip newline
        }
        
        public String getCity()
        {
            return this.line.substring(0, this.semicolon);
        }
    }
    
    public static void main(String[] args) throws NoSuchMethodException, SecurityException
    {
        Benchmark.run(BRC045_KeepChars.class, args);
    }
}
