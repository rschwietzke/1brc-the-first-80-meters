...
/**
 * Try to do less intermediate String operations
 * 
 * @author Rene Schwietzke
 */
public class BRC048_ImprovedStringHandling extends Benchmark
{
    /**
    ...
    private static class City
    {
        ...
        {
            this.city = new char[line.semicolon];
            for (int i = 0; i < line.semicolon; i++)
            {
                this.city[i] = line.line.charAt(i);
            }
    ...
    {
        Benchmark.run(BRC048_ImprovedStringHandling.class, args);
    }
}
