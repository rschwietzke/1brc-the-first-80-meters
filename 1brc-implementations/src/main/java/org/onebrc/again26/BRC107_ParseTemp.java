 ...
 */
public class BRC107_ParseTemp extends Benchmark
{
    /**
    ...
    public static class Line
    {
        ...
        {
            byte sign = this.backingArray[totalRead];
            int value = sign == '-' ? 0 : sign - '0';
            ...
            this.temperature = sign == '-' ? -value : value;
    ...
    {
        Benchmark.run(BRC107_ParseTemp.class, args);
    }
}
