...
/**
 * We want to try a new parseDouble implementation here, which is compact,
 * only deal with our number format and is neither safe nor general purpose.
 *
 * @author Rene Schwietzke
 */
public class BRC014_NewParseDouble extends Benchmark
{
    /**
    ...
    {
        final int negative = s.charAt(0) == '-' ? 1 : 0;
    ...
    {
		Benchmark.run(BRC014_NewParseDouble.class, args);
    }
}
