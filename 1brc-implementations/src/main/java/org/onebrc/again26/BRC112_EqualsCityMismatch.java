 ...
 */
public class BRC112_EqualsCityMismatch extends Benchmark
{
    /**
    ...
    private static class City
    {
        ...
        public boolean equalsCity(Line line)
        {
            ...
            else
            {
                ...
                return jdk.internal.util.ArraysSupport.mismatch(this.city, 0, line.backingArray, start, len) == -1;
            }
        }
    ...
    {
        Benchmark.run(BRC112_EqualsCityMismatch.class, args);
    }
}
