...
public class BRC30_OpenMap extends Benchmark
{
    ...
    public String run(final String fileName) throws IOException
    {
        ...
        final Map<String, Temperatures> cities = new HashMap<>(413 * 3);
    ...
    public static class LightMap<K, V>
    {
        ...
        public V compute(K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction)
        {
            ...
            {
                this.data[index] = key;
                final V t = (V) (this.data[index + 1] = remappingFunction.apply(key, null));
                this.size++;
            ...
            {
                return (V) (this.data[index + 1] = remappingFunction.apply(key, (V)this.data[index + 1]));
            }
            else
            {
        ...
        public V computeCollision(K key, int index, BiFunction<? super K, ? super V, ? extends V> remappingFunction)
        {
            ...
            while (true)
            {
                ...
                if (k == null)
                {
                    ...
                    final V t = (V) (this.data[nextIndex + 1] = remappingFunction.apply(key, null));
                    this.size++;
                ...
                {
                    return (V) (this.data[nextIndex + 1] = remappingFunction.apply(key, null));
                }
                nextIndex = (nextIndex + 2) & this.mask2;
            }
        }
