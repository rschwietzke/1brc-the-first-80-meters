...
/**
 * Parallelizes the stream after mapping lines to objects.
 *
 * Difference to BRC010_ParallelAfterRead: Moved `.parallel()` to after `.map(a -> new Measurement(a))`.
 *
 * @author Gunnar Morling
 * @author René Schwietzke
 */
public class BRC011_ParallelAfterMapping extends Benchmark 
{
    ...
    public String run(final String fileName) throws IOException
    {
        ...
        Map<String, ResultRow> measurements = 
                ...
                .map(l -> l.split(";"))
                .map(a -> new Measurement(a)).parallel()
                .collect(
    ...
    {
        Benchmark.run(BRC011_ParallelAfterMapping.class, args);
    }
}
