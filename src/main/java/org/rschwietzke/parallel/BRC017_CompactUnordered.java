 ...
 */
public class BRC017_CompactUnordered extends Benchmark 
{
    ...
    public String run(final String fileName) throws IOException
    {
        ...
        Map<String, ResultRow> measurements = 
                Files.lines(Paths.get(fileName)).parallel().unordered()
    ...
    {
        Benchmark.run(BRC017_CompactUnordered.class, args);
    }
}
