...
public class FastHashSet21
{
    ...
    public FastHashSet21()
    {
        this(13, 0.5f);
    }

    public FastHashSet21( final int size, final float fillFactor )
    {
    ...
    public City20 getPutOnEmpty( final City20 key, LineInfo line )
    {
