 ...
 */
public class BRC016_JFR_NoExtraString extends Benchmark
{
    /**
    ...
    {
        System.out.println("Warning: This version is for JFR learning purposes. It will loop until aborted!");
        
        while (true)
        {
            Benchmark.run(BRC016_JFR_NoExtraString.class, args);
        }
    }
}
