 ...
 */
public class Example10b_IntegerParsing extends Benchmark
{
	...
	public String run(final String fileName) throws IOException
	{
		...
		try (final var reader = new BufferedReader(new FileReader(fileName)))
		{
			...
			while((line = reader.readLine()) != null)
			{
				...
				final int next = i + 1;
				final int temperature = ParseDouble.parseInteger(line , next, line.length() - 1);
	...
	{
		Benchmark.run(Example10b_IntegerParsing.class.getDeclaredConstructor(), args);
	}
}
