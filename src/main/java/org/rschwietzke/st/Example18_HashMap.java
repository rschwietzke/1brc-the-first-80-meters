 ...
 */
public class Example18_HashMap extends Benchmark
{
	...
	{
		// our storage
		final HashMap<City, Temperatures> cities = new HashMap<>();
	...
	{
		Benchmark.run(Example18_HashMap.class.getDeclaredConstructor(), args);
	}
}
