 ...
 */
public class Example09_DoubleParsing extends Benchmark
{
	...
	public String run(final String fileName) throws IOException
	{
		...
		try (final var reader = new BufferedReader(new FileReader(fileName)))
		{
			...
			while((line = reader.readLine()) != null)
			{
				...
				final double temperature = ParseDouble.parseDouble(line.substring(i + 1));
	...
	{
		Benchmark.run(Example09_DoubleParsing.class.getDeclaredConstructor(), args);
	}
}
