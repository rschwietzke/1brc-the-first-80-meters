 ...
 */
public class Example22_SizedSet extends Benchmark
{
	@Override
	public String run(final String fileName) throws IOException
	{
		// our storage
		final FastHashSet21 cities = new FastHashSet21(500, 0.5f);
	...
	{
		Benchmark.run(Example22_SizedSet.class.getDeclaredConstructor(), args);
	}
}
