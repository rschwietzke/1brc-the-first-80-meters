...
import org.rschwietzke.util.FastHashSet21;
 ...
 */
public class Example21_DontReturnEmptyFromGet extends Benchmark
{
	@Override
	public String run(final String fileName) throws IOException
	{
		// our storage
		final FastHashSet21 cities = new FastHashSet21();
		...
		try (final var r = new LineInputStream2(new BufferedInputStream(new FileInputStream(fileName))))
		{
			...
			while ((l = r.readLine()) != null)
			{
				...
				// version of a city
				City20 totalsCity = cities.getPutOnEmpty(city, l);
	...
	{
		Benchmark.run(Example21_DontReturnEmptyFromGet.class.getDeclaredConstructor(), args);
	}
}
