 ...
 */
public class Example35_EqualsWithoutArrayMismatch extends Benchmark
{
	@Override
	...
	{
		Benchmark.run(Example35_EqualsWithoutArrayMismatch.class.getDeclaredConstructor(), args);
	}
