 ...
 */
public class Example25_SetWOHashCheck extends Benchmark
{
	@Override
	...
	{
		Benchmark.run(Example25_SetWOHashCheck.class.getDeclaredConstructor(), args);
	}
	...
	public static class FastHashSet
	{
	    ...
	    private static final City FREE_KEY = new City();
	    private static final City REMOVED_KEY = new City();
