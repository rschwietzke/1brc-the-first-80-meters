...
import org.rschwietzke.util.LineInputStream;
 ...
 */
public class Example15_ReadLinesAsByteArray extends Benchmark
{
	...
	{
		Benchmark.run(Example15_ReadLinesAsByteArray.class.getDeclaredConstructor(), args);
	}
}
