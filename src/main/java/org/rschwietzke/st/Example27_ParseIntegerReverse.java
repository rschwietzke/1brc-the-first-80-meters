 ...
 */
public class Example27_ParseIntegerReverse extends Benchmark
{
	@Override
	...
	{
		Benchmark.run(Example27_ParseIntegerReverse.class.getDeclaredConstructor(), args);
	}
	...
	public static class City implements Comparable<City>
	{
		...
		public void data(final LineInfo line)
		{
			...
			this.temperature = ParseDouble.parseIntegerReverse(line.buffer, line.separator + 1, line.end);
		}
