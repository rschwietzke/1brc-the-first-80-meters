 ...
 */
public class Example11c_NoCopyOfCity_DifferentHash extends Benchmark
{
	private static class City implements Comparable<City>
	{
		...
		public void process(final String data)
		{
			...
			this.hashCode = h;
			this.temperature = ParseDouble.parseDouble(data , splitPos + 1, length);
		}
...
//			}
	...
	{
		Benchmark.run(Example11c_NoCopyOfCity_DifferentHash.class.getDeclaredConstructor(), args);
	}
}
