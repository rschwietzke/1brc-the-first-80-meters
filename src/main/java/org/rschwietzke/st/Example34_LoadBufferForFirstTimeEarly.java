 ...
 */
public class Example34_LoadBufferForFirstTimeEarly extends Benchmark
{
	@Override
	...
	{
		Benchmark.run(Example34_LoadBufferForFirstTimeEarly.class.getDeclaredConstructor(), args);
	}
